...
// // Получить все аудиофайлы в папке "аудио"
// const audioFiles = document.querySelectorAll('audio[src*="audio/"]');

// // Создать пустой массив для хранения путей к аудиофайлам
// const audioPaths = [];

// // Заполнить массив audioPaths путями к аудиофайлам
// for (const audioFile of audioFiles) {
//   audioPaths.push(audioFile.src);
// }
...
//   // Выбрать случайный путь к аудиофайлу из массива audioPaths
//   const randomPath = audioPaths[Math.floor(Math.random() * audioPaths.length)];

//   // Создать новый объект Audio
